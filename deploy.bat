...
REM ============================================
REM ============================================
SET "PLUIGN_NAME=Automation for WPCourseware"
SET "PLUGIN_TAGS=Automation, WPCourseware, Flowmattic"
